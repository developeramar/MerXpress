...
<div className='flex items-center justify-between pt-5'>
  ...
  <div className='flex justify-end p-5'>
      ...
      {totalNotifications > 0 && (
        ...
        <li
          className='flex items-center text-xl hover:bg-zinc-300 rounded-md p-2 text-black cursor-pointer'
        ...
        {showProductSubMenu && (
          <ul className='ml-6'>
            <li className='flex items-center p-2 ml-3 text-black hover:bg-zinc-300 rounded-md'>
              <Link to='/addproduct' onClick={onClose}>Add Product</Link>
            </li>
            <li className='flex items-center p-2 ml-3 text-black hover:bg-zinc-300 rounded-md'>
              <Link to='/productmanagement' onClick={onClose}>Product Management</Link>
            </li>
    ...
    <li className='flex items-center p-2  text-xl hover:bg-zinc-300 rounded-md text-black'>
      ...
      <Link to='/Promotions' onClick={onClose}>Promotions</Link>
    </li>

    {/* Link 6 */}
    <li className='flex items-center p-2 text-xl  hover:bg-zinc-300 rounded-md text-black'>
      <FaGift className='mr-4 sm:hidden md:block' />
     <Link to='/Promotions'onClick={onClose}>Advertise</Link>
    </li>
    ...
    <FaCog className='mr-4 sm:hidden md:block' />
     <Link to='/AccountStatement' onClick={onClose}>Account Statement</Link>
    </li>
      </ul>
      {/* Close Icon */}
